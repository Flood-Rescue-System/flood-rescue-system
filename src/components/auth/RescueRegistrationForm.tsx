...
export default function RescueRegistrationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Validate master key
      if (formData.masterKey !== process.env.NEXT_PUBLIC_RESCUE_MASTER_KEY) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-2">Create your rescue team account</p>
      </div>
